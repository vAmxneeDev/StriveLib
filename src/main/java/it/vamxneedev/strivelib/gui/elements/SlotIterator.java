...
public interface SlotIterator {
    ...
    SlotIterator blacklist(SlotPosition slotPosition);
    ...
    class Impl implements SlotIterator {
        ...
        private InventoryElements contents;
        private StriveInventory inv;
        ...
        private Set<SlotPosition> blacklisted = new HashSet<>();

        public Impl(InventoryElements contents, StriveInventory inv,
        ...
        public SlotIterator blacklist(int row, int column) {
            this.blacklisted.add(SlotPosition.of(row, column));
            return this;
        }

        @Override
        public SlotIterator blacklist(SlotPosition slotPos) {
        ...
        private boolean canPlace() {
            return !blacklisted.contains(SlotPosition.of(row, column)) && (allowOverride || !this.get().isPresent());
        }
    }
}