package it.vamxneedev.strivelib.gui.managers;

import it.vamxneedev.strivelib.gui.StriveInventory;
import it.vamxneedev.strivelib.gui.elements.InventoryElements;
import it.vamxneedev.strivelib.gui.listeners.InventoryListener;
import it.vamxneedev.strivelib.gui.opener.ChestInventoryOpener;
import it.vamxneedev.strivelib.gui.opener.InventoryOpener;
import it.vamxneedev.strivelib.gui.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<UUID, StriveInventory> inventories;
    private Map<UUID, InventoryElements> contents;
    ...
    public List<Player> getOpenedPlayers(StriveInventory inv) {
    ...
    public Optional<StriveInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    public void setInventory(Player p, StriveInventory inv) {
        if (inv == null)
    ...
    public Optional<InventoryElements> getContents(Player p) {
        return Optional.ofNullable(this.contents.get(p.getUniqueId()));
    }

    public void setContents(Player p, InventoryElements contents) {
        if (contents == null)
    ...
    public void handleInventoryOpenError(StriveInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening StriveInventory:", exception);
    }

    public void handleInventoryUpdateError(StriveInventory inventory, Player player, Exception exception) {
        inventory.close(player);
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                StriveInventory inv = inventories.get(p.getUniqueId());
